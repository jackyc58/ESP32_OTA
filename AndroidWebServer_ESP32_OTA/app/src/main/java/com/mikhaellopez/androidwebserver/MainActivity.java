...
public class MainActivity extends AppCompatActivity {
    ...
    private final static int REQ_WRITE_EXTERNAL_STORAGE = 100;
    @AfterPermissionGranted(REQ_WRITE_EXTERNAL_STORAGE)
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (EasyPermissions.hasPermissions(this, perms)) {
                ...
                EasyPermissions.requestPermissions(
                        new PermissionRequest.Builder(this, REQ_WRITE_EXTERNAL_STORAGE, perms)
                                .setRationale(R.string.storage_auth)
